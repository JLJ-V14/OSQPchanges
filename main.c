...
void main_optimizacionC(void) {
    ...
    Datos_CSV***                                       Data_Terminales;     //Informacion de los terminales.
	Datos_CSV***                                       Data_Vehiculos;      //Informacion de los vehiculos
	Datos_CSV***                                       Data_Tiempo;         //Datos de tiempo de la simulacion
	Datos_CSV***                                       Data_Restricciones;  //Restricciones del sistema
	Datos_CSV***                                       Data_Precio_Compra;  //Precios de compra del kW/h
	Datos_CSV***                                       Data_Precio_Venta;   //Precios de venta  del kW/h
	Datos_CSV***                                       Data_Baterias;       //Datos   de las baterias del sistema
